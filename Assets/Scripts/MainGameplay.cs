...
public class MainGameplay : MonoBehaviour
{
    ...
    private TreeNode SequenceFallingAttack()
    {
    ...
    private TreeNode SequenceJumpAttack()
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequenceLittleAttack()
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequenceMiddleAttack()
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequenceBigAttack()
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequenceToNextStep(int step)
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequenceIntro()
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequencePhase1()
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequencePhase2()
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequenceAllPhase1()
    {
        Sequence sequence = new Sequence();
    ...
    private TreeNode SequenceAllPhase2()
    {
        Sequence sequence = new Sequence();
    ...
    private void CreateBehavior()
    {
        ...
        TreeNode sequence = SequenceIntro();
